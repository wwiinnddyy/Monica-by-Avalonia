...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["LocalDatabaseDescription"] = "Avalonia uses the Monica v69 SQLite schema as the canonical desktop vault.",
    ...
    private static readonly Dictionary<string, string> Chinese = new()
    {
        ...
        ["LocalDatabase"] = "本地数据库",
        ["LocalDatabaseDescription"] = "Avalonia 使用 Monica v69 SQLite 架构作为桌面端主保险库。",
